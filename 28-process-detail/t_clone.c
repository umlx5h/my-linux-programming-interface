...
main(int argc, char *argv[])
{
    ...
    // But don't ignore SIGCHLD (which is ignored by default), since that would prevent the creation of a zombie.
    ...
    __WCLONNE is need for child notifying with signal other than SIGCHLD */
